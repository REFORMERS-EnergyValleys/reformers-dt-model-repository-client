...
from reformers_model_repo_client.api.add_artifacts_api import AddArtifactsApi


class TestAddArtifactsApi(unittest.TestCase):
    """AddArtifactsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AddArtifactsApi()
