...
class TestRepositoryComponentInfo(unittest.TestCase):
    """RepositoryComponentInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RepositoryComponentInfo:
        """Test RepositoryComponentInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RepositoryComponentInfo`
        """
        model = RepositoryComponentInfo()
        if include_optional:
            return RepositoryComponentInfo(
    ...
    def testRepositoryComponentInfo(self):
        """Test RepositoryComponentInfo"""
