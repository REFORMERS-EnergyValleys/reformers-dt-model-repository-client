...
class TestManifestNotFoundErrorsInner(unittest.TestCase):
    """ManifestNotFoundErrorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManifestNotFoundErrorsInner:
        """Test ManifestNotFoundErrorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManifestNotFoundErrorsInner`
        """
        model = ManifestNotFoundErrorsInner()
        if include_optional:
            return ManifestNotFoundErrorsInner(
    ...
    def testManifestNotFoundErrorsInner(self):
        """Test ManifestNotFoundErrorsInner"""
