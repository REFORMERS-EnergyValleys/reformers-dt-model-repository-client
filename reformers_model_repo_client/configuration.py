...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "BasicHttpAuthentication": BasicAuthSetting,
    },
    total=False,
)
...
conf = reformers_model_repo_client.Configuration(
    username='the-user',
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://reformers-dev.vlab-central.ait.ac.at" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("reformers_model_repo_client")
