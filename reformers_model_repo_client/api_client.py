...
from reformers_model_repo_client.api_response import ApiResponse, T as ApiResponseT
import reformers_model_repo_client.models
from reformers_model_repo_client import rest
from reformers_model_repo_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(reformers_model_repo_client.models, klass)
