...
class RepositorySettingsApi:
    ...
    def repository_settings(
        ...
        _param = self._repository_settings_serialize(
    ...
    @validate_call
    def repository_settings_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RepositorySetting]]:
        """Retrieve information about available components in the repository.
    ...
    @validate_call
    def repository_settings_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _repository_settings_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/service/rest/v1/repositorySettings',
