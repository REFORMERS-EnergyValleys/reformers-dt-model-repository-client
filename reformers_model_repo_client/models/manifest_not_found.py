...
class ManifestNotFound(BaseModel):
    """
    ManifestNotFound
    """ # noqa: E501
    errors: Optional[List[ManifestNotFoundErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [ManifestNotFoundErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
