...
class BlobNotFound(BaseModel):
    """
    BlobNotFound
    """ # noqa: E501
    errors: Optional[List[BlobNotFoundErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [BlobNotFoundErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
