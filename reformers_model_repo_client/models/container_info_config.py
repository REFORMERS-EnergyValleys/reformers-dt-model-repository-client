...
class ContainerInfoConfig(BaseModel):
    """
    ContainerInfoConfig
    """ # noqa: E501
    env: Optional[List[StrictStr]] = Field(default=None, alias="Env")
    cmd: Optional[List[StrictStr]] = Field(default=None, alias="Cmd")
    labels: Optional[Dict[str, StrictStr]] = Field(default=None, alias="Labels")
    __properties: ClassVar[List[str]] = ["Env", "Cmd", "Labels"]
