...
class RepositoryComponentInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "repository", "format", "group", "name", "version", "assets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assets": [AssetInfo.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None
        })
        return _obj
