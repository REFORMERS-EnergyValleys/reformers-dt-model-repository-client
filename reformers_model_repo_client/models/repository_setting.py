...
class RepositorySetting(BaseModel):
    ...
    format: StrictStr = Field(description="Component format held in this repository")
    type: StrictStr = Field(description="Controls if deployments of and updates to artifacts are allowed")
    url: StrictStr = Field(description="URL to the repository")
    online: StrictBool = Field(description="Whether this repository accepts incoming requests")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "format", "type", "url", "online"]
